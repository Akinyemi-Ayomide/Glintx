...
const slides = [
  {
    ...
    text: 'EDUVATE 1.0',
    text2:
      'ENJOY A BETTER EDUCATIONAL ENVIRONMENT AND SEAMLESS ACCESS TO EDUCATION INSTITUTIONS',
  ...
  },
  {
    ...
    text2:
      'INVEST IN YOUR SCHOOL NOW, BECOME A BETTER AND MORE RECOGNIZABLE SCHOOL TODAY',
